...
public class DownloadXML extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<String> resultXML = (List<String>) request.getAttribute("res");
        
       // reads input file from an absolute path
        File downloadFile = new File( srcPath + "outputXmlFiles/results.xml" );        
         
        // obtains ServletContext
        ServletContext context = getServletContext();
         
        // gets MIME type of the file
        String mimeType = context.getMimeType(srcPath + "outputXmlFiles/results.xml" );
        if (mimeType == null) {        
