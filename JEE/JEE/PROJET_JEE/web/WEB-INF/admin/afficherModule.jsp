                ...
                <div class="col-md-6 offset-3">
                    <div class="panel panel-success">
                        <div class="panel-body">    
                            ...
                            <form class="form-inline md-form mr-auto mb-4" action="Cntrl_adm?page=chercherMod" method="post">
                    ...
                    <tbody>
                        ...
                        <c:forEach items="${listTransformationEnNom.list_trasnformation}" var="list">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="<%=request.getContextPath()%>/Cntrl_adm?page=supprimer" method="post"> 
                                        <input type="hidden" name="id_module" value="${list.id_module}" />
                                        <input onclick="return confirm('Etes vous sur de supprimer ce module ?')" type="submit" value="Supprimer"/>
                                    </form>
                                    <form action="<%=request.getContextPath()%>/Cntrl_adm?page=Telecharger_module" method="post"> 
